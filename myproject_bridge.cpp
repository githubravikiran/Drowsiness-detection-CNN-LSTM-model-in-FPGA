...
void myproject_float(
    ...
    input_t input_layer_1_ap[33*11*1];
    nnet::convert_data<float, input_t, 33*11*1>(input_layer_1, input_layer_1_ap);

    result_t layer15_out_ap[1];

    myproject(input_layer_1_ap,layer15_out_ap);
...
void myproject_double(
    ...
    input_t input_layer_1_ap[33*11*1];
    nnet::convert_data<double, input_t, 33*11*1>(input_layer_1, input_layer_1_ap);
